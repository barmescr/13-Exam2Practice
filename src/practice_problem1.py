...
class Box(object):
    ...
    def __init__(self, contents, volume):
        ...
        self.volume_i = volume
        if len(contents) <= volume:
            self.contents_i = contents
        else:
            self.contents_i = str()
    ...
    def double(self):
        ...
        con = self.append_string(self.contents)
        return con
    ...
    def shrink(self, new_volume):
        ...
        con = self.append_string(contents)
        return con
    ...
    def reset(self):
        ...
        self.volume = self.volume_i
        self.contents =self.contents_i
    ...
    def steal(self, other_box):
        ...
        self.contents = self.contents_i + self.append_string(other_box.contents)
        other_box.contents = self.append_string(self.contents)
